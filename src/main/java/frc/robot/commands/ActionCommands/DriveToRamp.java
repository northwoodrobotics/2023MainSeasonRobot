...
public class DriveToRamp extends CommandBase{
    ...
    public void initialize(){
        ...
        robotToTag = new Transform2d(m_Swerve.dt.getPose(), DriveConstants.rampPose);
        ...
        Route2Tag = PathPlanner.generatePath(
            ...
            new PathPoint(DriveConstants.rampPose.getTranslation(), robotToTag.getRotation(), DriveConstants.rampPose.getRotation())
            );
