...
public class HuskyPathFollower extends CommandBase{
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      HuskyPathFollower::defaultLogError;

  /**
   * Constructs a new HuskyPathFollowerCommand that when executed will follow the provided
   * trajectory. This command will not return output voltages but ChassisSpeeds from the position
   * controllers which need to be converted to module states and put into a velocity PID. This uses a custom implemenation of second order kinematics
   * 
   *
  ...
  public static void setLoggingCallbacks(
    ...
    HuskyPathFollower.logActiveTrajectory = logActiveTrajectory;
    HuskyPathFollower.logTargetPose = logTargetPose;
    HuskyPathFollower.logSetpoint = logSetpoint;
    HuskyPathFollower.logError = logError;
  }
}
