...
public class DeadReckoningHuskyPoseEstimator {
  ...
  private final SecondOrderOdometry m_odometry;
   ...
   */
  public DeadReckoningHuskyPoseEstimator(
  ...
  public DeadReckoningHuskyPoseEstimator(
    ...
    m_odometry = new SecondOrderOdometry(kinematics, gyroAngle, modulePositions, initialPoseMeters);
